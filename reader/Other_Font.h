const char cyAll[8][16] = {"爱屋及乌      ","如饥似渴      ","大名鼎鼎      ","恩重如山      ","欢声笑语      "};

const char myAll[8][64] = {"如果你因失去了太阳而流泪，那么你也将失去群星了", "为众人抱薪者，不可使其冻毙于风雪","时间就像海绵里的水，只要愿意挤，总是还有的", "业精于勤，荒于戏。行成于思，毁于随", "书山有路勤为径，学海无涯苦作舟"};

const char dpcq[] = "斗之力，三段\
...
下一个，萧媚听着测验人的喊声，一名少女快的人群中跑出，少女刚刚出场，附近的议论声便是小了许多，一双双略微火热的目光，牢牢的锁定着少女的脸颊\
